...
-- 6.
	...
	--b.write a query that displays any Product description with underscore value in its description.
...
select sum(totalDue) as SumToatalDue , OrderDate
from Sales.SalesOrderHeader
...
-- 11.
	  ...
	  select  rowguid ,Name, SalesPersonID, Demographics into store_Archive_Empty from Sales.Store where 1=0;
