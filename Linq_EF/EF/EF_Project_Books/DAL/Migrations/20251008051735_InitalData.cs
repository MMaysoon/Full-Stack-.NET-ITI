...
namespace DAL.Migrations
{
    ...
    public partial class InitalData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReviewId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    VectorName = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "BooksId", "Description", "ImageUrl", "Price", "PublishedOn", "Publisher", "Title" },
                values: new object[,]
                {
                    { 1, "Clean Code Clean Code Clean Code", "cleancode.jpg", 39.990000000000002, new DateTime(2008, 8, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Maysoon", "Clean Code" },
                    { 2, "Improving the Design of Existing Code", "refactoring.jpg", 45.0, new DateTime(2018, 11, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "Menah", "Refactoring" }
                });
